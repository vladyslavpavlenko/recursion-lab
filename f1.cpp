...
int f1(int n) {
    ...
    std::osyncstream(std::cout) << "[" << this_id << "] f1() is called\n";
    ...
    // std::osyncstream(std::cout) << "[" << this_id << "] f1 returns " << res1 << " from f" << rand-1 << "(" << n-1 << ")\n";
    ...
    // std::osyncstream(std::cout) << "[" << this_id << "] f1 returns " << res2 << " from f" << rand-1 << "(" << n-1 << ")\n";
